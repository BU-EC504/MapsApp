  ...
  function addListenerToMap(){
	...
	else
	{
		...
		var circle = new google.maps.Circle({
			...
			for (var i = 0; i < 5; i++) {
				markerLat = getRandomArbitrary(e.overlay.getPosition().lat(), e.overlay.getPosition().lat()+1.5);
				markerLng = getRandomArbitrary(e.overlay.getPosition().lng(), e.overlay.getPosition().lng()+1.5);
				//alert(markerLat); alert(markerLng);
